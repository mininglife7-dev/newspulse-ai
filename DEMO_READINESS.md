...
| --- | ------------------------------------------ | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Deployment (code + database live)          | **VERIFIED** | EU: run `29586277262` (2026-07-17) — Frankfurt certified from logs; schema + CEIS + RLS + security tests green. Caveat: app env still points at Tokyo until Founder's Vercel repoint                                                    |
