...
import { commandIncident, type IncidentTrigger } from '@/lib/incident-commander';
    ...
    const actionMessage =
      command.decision === 'autorollback'
        ...
        : command.decision === 'manual_review'
          ...
          : 'No action taken';
    recordAlert('performance', body.severity, `Incident: ${body.type}`, `${body.message} — ${actionMessage}`);
