...
- **Description:** PostgreSQL database password (for schema deployment)
...
- **Important:** Only used by GitHub Actions deploy workflow, never by application
...
5. Copy:
   ...
   - **Database password** → `SUPABASE_DB_PASSWORD` (in Settings → Database tab)
