...
- Escalation protocol: Agent can *recommend* strategy, but only founder can *approve* it
...
**Situation**: Early governance documents stated how things *should* work; actual practice diverged.
