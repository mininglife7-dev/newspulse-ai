...
-- Risk assessments: active workspace members can read, create, and update
...
-- Obligations: active workspace members can read, create, and update
...
-- Evidence: active workspace members can read, create, and update
...
-- Remediation plans: active workspace members can read, create, and update
...
-- Companies: add update policy for workspace members
