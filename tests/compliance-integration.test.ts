...
describe('Compliance System Integration', () => {
  describe('End-to-end: Assessment → Obligations → Metrics', () => {
    it('should generate high-risk obligations when assessment classifies as high-risk', () => {
      ...
      const assessment = assessRisk({
        systemType: 'classification_model',
        dataCategories: ['financial_data'],
        useCases: ['financial_credit'],
        autonomyLevel: 'high',
        affectsRights: true,
        publicFacing: false,
      });
    ...
    it('should generate unacceptable-risk obligations when assessment detects prohibited practices', () => {
      // Step 1: Detect prohibited practice (emotion recognition in employment = unacceptable)
      const assessment = assessRisk({
        systemType: 'emotion_recognition',
  ...
  describe('Risk Assessment Edge Cases', () => {
    it('should handle systems with multiple high-risk indicators', () => {
      const assessment = assessRisk({
        systemType: 'classification_model',
        dataCategories: ['biometric_data', 'health_data'],
        useCases: ['financial_credit', 'law_enforcement'],
        autonomyLevel: 'high',
        affectsRights: true,
        publicFacing: false,
      });
