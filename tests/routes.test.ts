...
describe('classifyRoute', () => {
  ...
  it.each(['/dashboard', '/dashboard/settings', '/workspace', '/workspace/setup', '/assessment', '/assessment/sys-1', '/assessments', '/inventory', '/api/workspace', '/api/ai-systems', '/api/assessments'])(
    'protects %s',
    (path) => {
